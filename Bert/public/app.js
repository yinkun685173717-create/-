...
const PASSWORD_KEY = "yinkunRestaurantPassword";
...
const dishes = [
  { id: "chili-pork", name: "辣椒炒肉", image: commonsImage("Fried Pork with Pepper 20210630.jpg"), fallback: "assets/dishes/chili-pork.png" },
  { id: "potato-shreds", name: "炒土豆丝", image: commonsImage("Liang ban tu dou si.jpg"), fallback: "assets/dishes/potato-shreds.png" },
  { id: "scallion-beef", name: "葱爆牛肉", image: commonsImage("Stir-fried beef with spring onion by cyclonebill.jpg"), fallback: "assets/dishes/scallion-beef.png" },
  { id: "seaweed-egg-soup", name: "紫菜蛋汤", image: commonsImage("Egg drop soup.jpg"), fallback: "assets/dishes/seaweed-egg-soup.png" },
  { id: "lettuce-egg", name: "莴苣炒蛋", image: commonsImage("Scrambled Eggs with Chives and Asiago (4594228418).jpg"), fallback: "assets/dishes/lettuce-egg.png" },
  { id: "cauliflower-pot", name: "干锅花菜", image: commonsImage("Cauliflower-bajirak-bokkeum.jpg"), fallback: "assets/dishes/cauliflower-pot.png" },
  { id: "edamame-pork", name: "毛豆炒肉丝", image: commonsImage("Wok-fried edamame by joyosity.jpg"), fallback: "assets/dishes/edamame-pork.png" },
  { id: "crayfish", name: "小龙虾", image: commonsImage("Spicy crayfish.jpg"), fallback: "assets/dishes/crayfish.png" },
  { id: "greens", name: "炒青菜", image: commonsImage("Stir Fried Bok Choy, Aug 2025.jpg"), fallback: "assets/dishes/greens.png" },
  { id: "chives", name: "炒韭菜", image: commonsImage("Scrambled Eggs with Chives and Asiago (4594228418).jpg"), fallback: "assets/dishes/chives.png" },
  { id: "sprouts-beef", name: "豆芽炒牛肉", image: commonsImage("Tomato ramen with beef 20200906.jpg"), fallback: "assets/dishes/sprouts-beef.png" },
];
...
async function renderOrders() {
  ...
  try {
    ...
    ordersList.innerHTML = `<div class="empty-state">订单读取失败：${error.message}</div>`;
    showToast(`订单读取失败：${error.message}`);
  }
}
...
guestRoleBtn.addEventListener("click", () => setRole("guest"));
chefRoleBtn.addEventListener("click", () => setRole("chef"));
...
if (localStorage.getItem(SESSION_KEY) === "true" && state.password) {
  setAuthenticated(true);
} else {
  setAuthenticated(false);
}
